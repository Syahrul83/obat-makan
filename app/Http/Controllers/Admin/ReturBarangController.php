...
class ReturBarangController extends Controller
{
    ...
    {
        $title = 'Retur Barang | Admin';
        $page  = 'retur-barang';
        $link  = 'penjualan';

        return view('Admin.retur-barang.main',compact('title','page','link'));
    }

    public function tambah()
    {
        $title       = 'Form Retur Barang | Admin';
        $page        = 'retur-barang';
        $link        = 'penjualan';
        $obat        = Obat::where('status_delete',0)->get();
        $nomor_retur = generateCodeTrx('retur-barang');

        return view('Admin.retur-barang.form-retur-barang',compact('title','page','link','obat','nomor_retur'));
    }
    ...
    public function save(Request $request)
    {
        ...
        return redirect('/admin/retur-barang')->with('message','Berhasil Input Retur Barang');
    }

    public function detail($id)
    {
        $title = 'Retur Barang Detail | Admin';
        $page  = 'retur-barang';
        $link  = 'penjualan';

        return view('Admin.retur-barang.retur-barang-detail',compact('title','page','link','id'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('/admin/retur-barang')->with('message','Berhasil Hapus Data');
    }
    ...
    //     return redirect('/admin/retur-barang/detail/'.$id)->with('message','Berhasil Hapus Data');
    // }
}
