...
class DataKreditController extends Controller
{
    public function index() 
    {
        ...
        $link  = 'penjualan';
        $page  = 'data-kredit';
        return view('Admin.kredit.main',compact('title','link','page'));
    }

    public function delete($id) 
    {
        Kredit::where('id_kredit',$id)->delete();
        return redirect('/admin/data-kredit')->with('message','Berhasil Hapus Data');
    }
    ...
    public function kreditFaktur($id)
    {
        ...
        return view('Admin.kredit.kredit-faktur',compact('id','link','title','page'));
    }

    public function deleteKreditFaktur($id,$id_faktur) 
    {
        KreditFaktur::where('id_kredit_faktur',$id_faktur)->delete();
        return redirect('/admin/data-kredit/detail/'.$id)->with('message','Berhasil Hapus Data');
    }
    ...
    public function kreditDetail($id,$id_faktur) 
    {
        ...
        $link  = 'penjualan';
        $page  = 'data-kredit';
        return view('Admin.kredit.detail',compact('id','id_faktur','link','title','page'));
    }
    ...
    public function cetakInvoice($id,$id_faktur)
    {
        ...
        return view('Admin.print-kredit',compact('total_kredit','nama_pelanggan','data','profile_instansi','kredit_faktur'));
    }
    ...
    public function deleteKreditDetail($id,$id_faktur,$id_detail) 
    {
        ...
        return redirect('/admin/data-kredit/detail/'.$id.'/lihat-hutang/'.$id_faktur)->with('message','Berhasil Hapus Data');
    }
    ...
    public function lunasSemua($id,$id_faktur)
    {
        ...
        return redirect('/admin/data-kredit/detail/'.$id.'/lihat-hutang/'.$id_faktur)->with('message','Berhasil Lunaskan Semua Hutang');
    }
    ...
    public function lunasHutang($id,$id_faktur,$id_kredit_det)
    {
        ...
        return redirect('/admin/data-kredit/detail/'.$id.'/lihat-hutang/'.$id_faktur)->with('message','Berhasil Lunaskan Hutang');
    }
}
