...
class PabrikObatController extends Controller
{
    ...
    {
        $title = 'Data Pabrik Obat | Admin';
        $link  = 'obat';
        $page  = 'data-pabrik-obat';
        return view('Admin.pabrik-obat.main',compact('title','link','page'));
    }

    public function tambah() 
    {
        $title = 'Form Pabrik Obat | Admin';
        $link  = 'obat';
        $page  = 'data-pabrik-obat';
        return view('Admin.pabrik-obat.form-pabrik-obat',compact('title','link','page'));
    }
    ...
    public function edit($id) 
    {
        ...
        return view('Admin.pabrik-obat.form-pabrik-obat',compact('title','link','page','row'));
    }

    public function delete($id) 
    {
        PabrikObat::where('id_pabrik_obat',$id)->update(['status_delete' => 1]);
        return redirect('/admin/data-pabrik-obat')->with('message','Berhasil Hapus PabrikObat');
    }
    ...
    public function save(Request $request) 
    {
        ...
        return redirect('/admin/data-pabrik-obat')->with('message',$message);
    }
}
