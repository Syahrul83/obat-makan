...
class JamShiftController extends Controller
{
    ...
    {
        $title = 'Data Jam Shift | Kasir';
        $link  = 'data-master';
        $page  = 'jam-shift';
        return view('Kasir.jam-shift.main',compact('title','link','page'));
    }

    public function tambah() 
    {
        $title = 'Form Jam Shift | Kasir';
        $link  = 'data-master';
        $page  = 'jam-shift';
        return view('Kasir.jam-shift.form-jam-shift',compact('title','link','page'));
    }
    ...
    public function edit($id) 
    {
        ...
        return view('Kasir.jam-shift.form-jam-shift',compact('title','link','page','row'));
    }

    public function delete($id) 
    {
        JamShift::where('id_jam_shift',$id)->update(['status_delete'=>1]);
        return redirect('/kasir/jam-shift')->with('message','Berhasil Hapus Jenis Obat');
    }
    ...
    public function save(Request $request) 
    {
        ...
        return redirect('/kasir/jam-shift')->with('message',$message);
    }
}
