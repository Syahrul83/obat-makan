...
class PembelianController extends Controller
{
    public function index()
    {
        ...
        $link  = 'pembelian';
        $page  = 'data-pembelian';
        return view('Kasir.pembelian.main',compact('title','link','page'));
    }
    ...
    public function tambah() 
    {
        ...
        return view('Kasir.pembelian.form-pembelian',compact('title','link','page','supplier','obat'));
    }

    public function delete($id) 
    {
        PembelianObat::where('id_pembelian_obat',$id)->delete();
        return redirect('/kasir/data-pembelian')->with('message','Berhasil Hapus Data Pembelian');
    }
    ...
    {   
        ...
        return view('Kasir.pembelian.pembelian-print',compact('pembelian','pembelian_detail','profile_instansi'));
    }
    ...
    public function cetak($id)
    {
        ...
        return view('Kasir.pembelian.pembelian-cetak',compact('pembelian','pembelian_detail','profile_instansi','calc_dpp'));
    }
    ...
    public function detail($id)
    {
        ...
        $page  = 'data-pembelian';
        return view('Kasir.pembelian.main-detail',compact('title','page','id'));
    }

    public function deleteDetail($id,$id_detail) 
    {
        PembelianDetail::where('id_pembelian_detail',$id_detail)->delete();
        return redirect('/kasir/data-pembelian/detail/'.$id)->with('message','Berhasil Hapus Data Pembelian');
    }
    ...
    public function historyBeli()
    {
        ...
        return view('Kasir.history-beli.main',compact('title','link','page','obat'));
    }
    ...
    public function kartuStok()
    {
        ...
        return view('Kasir.kartu-stok.main',compact('title','link','page','obat'));
    }
    ...
    public function kartuStokCetak(Request $request)
    {
        ...
        return view('Kasir.kartu-stok.cetak-kartu-stok',compact('tanggal_dari','tanggal_sampai','nama_obat','get_kartu_stok','sum_beli','sum_jual','sum_saldo'));
    }
}
