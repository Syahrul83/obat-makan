...
class MarginObatController extends Controller
{
    ...
    {
        $title = 'Margin Obat | Kasir';
        $link  = 'data-master';
        $page  = 'margin-obat';
        $check = MarginObat::count();
        return view('Kasir.margin-obat.main',compact('title','link','page','check'));
    }

    public function tambah() 
    {
        $title = 'Form Margin Obat | Kasir';
        $link  = 'data-master';
        $page  = 'margin-obat';
        return view('Kasir.margin-obat.form-margin-obat',compact('title','link','page'));
    }
    ...
    public function edit($id) 
    {
        ...
        return view('Kasir.margin-obat.form-margin-obat',compact('title','link','page','row'));
    }
    ...
    public function save(Request $request) 
    {
        ...
        return redirect('/kasir/margin-obat')->with('message',$message);
    }
}
