...
class RacikObatController extends Controller
{
    public function dataTransaksiRacik()
    {
        ...
        return view('Kasir.transaksi.transaksi-racik-obat',compact('title','link','page'));
    }
    ...
    public function dataRacikObat($id)
    {
        ...
        return view('Kasir.racik-obat.data-racik-obat',compact('title','link','page','id','nomor_transaksi'));
    }
    ...
    public function dataRacikObatDetail($id,$id_detail)
    {
        ...
        return view('Kasir.racik-obat.data-racik-obat-detail',compact('title','link','page','id','id_detail','nomor_transaksi'));
    }
    ...
    public function racikObat()
    {
        ...
        return view('Kasir.racik-obat',compact('obat','pasien','dokter'));
    }
    ...
    public function bayarRacikObat(Request $request)
    {
        ...
        return view('Kasir.racik-obat-print',compact('kode_transaksi','diskon','tanggal_sekarang','jam_sekarang','total_semua_racik','grand_total','bayar','kembalian','get_obat_non_resep','get_resep_total','get_obat_resep','profile_instansi','sum_total','get_pasien','get_dokter','sum_total_racik'));
    }
    ...
    public function cetakInvoice($id) 
    {
        ...
        return view('Kasir.racik-obat-cetak',compact('transaksi_racik','profile_instansi','sum_total','sum_total_racik','get_pasien','get_dokter','get_obat_non_resep','get_resep_total','get_obat_resep'));
    }
}