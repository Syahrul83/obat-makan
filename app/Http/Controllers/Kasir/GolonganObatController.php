...
class GolonganObatController extends Controller
{
    ...
    {
        $title = 'Golongan Obat | Kasir';
        $link  = 'obat';
        $page  = 'data-golongan-obat';
        return view('Kasir.golongan-obat.main',compact('title','link','page'));
    }

    public function tambah()
    {
        $title = 'Form Golongan Obat | Kasir';
        $link  = 'obat';
        $page  = 'data-golongan-obat';
        return view('Kasir.golongan-obat.form-golongan-obat',compact('title','link','page'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('Kasir.golongan-obat.form-golongan-obat',compact('title','link','page','row'));
    }
    ...
    public function save(Request $request)
    {
        ...
        return redirect('/kasir/data-golongan-obat')->with('message',$message);
    }

    public function delete($id)
    {
        GolonganObat::where('id_golongan_obat',$id)->update(['status_delete'=>1]);
        return redirect('/kasir/data-golongan-obat')->with('message','Berhasil Hapus Data');
    }
}
