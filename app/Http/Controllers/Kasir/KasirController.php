...
class KasirController extends Controller
{
	public function index() 
	{
		...
		return view('Kasir.kasir',compact('pelanggan','supplier','obat'));
	}
	...
	public function bayar(Request $request) 
	{
		...
		if ($bayar_tunai) {
			...
			return view('Kasir.cetak-bayar',compact('transaksi','sum_diskon','transaksi_detail','profile_instansi','sum_sub_total_obat'));
		}
		elseif ($kredit) {
			...
			session()->forget('nomor_upds_relasi');
			return view('Kasir.cetak-kredit',compact('harga_satuan','diskon_urai','total_kredit','nama_pelanggan','data','profile_instansi','nomor_faktur','kredit_faktur'));
		}
	}
}
