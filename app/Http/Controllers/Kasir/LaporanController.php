...
class LaporanController extends Controller
{
    public function index()
    {
        ...
        return view('Kasir.laporan-data.main',compact('title','page'));
    }
    ...
    public function laporanPemakaianObat(Request $request)
    {
        ...
        $spreadsheet->getActiveSheet()->setCellValue('H7','Hna');
        ...
        foreach ($obat as $index => $value) {
            ...
            $spreadsheet->getActiveSheet()->setCellValue('H'.$cell,$value->harga_modal * $value->stok_pakai);
            $cell = $cell+1;
        }
        ...
        $spreadsheet->getActiveSheet()->getStyle('H8:H'.$cell)->getNumberFormat()->setFormatCode('"Rp "#,##0.00_-');
        ...
        foreach ($obat as $index => $value) {
            ...
            $spreadsheet->getActiveSheet()->setCellValue('H'.$cell,$value->harga_modal * $sum_total_pakai);
            $cell = $cell+1;
        }
