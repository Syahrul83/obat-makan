...
class DataTransaksiController extends Controller
{
    public function index() 
    {
        ...
        $link  = 'penjualan';
        $page  = 'data-penjualan';
        return view('Kasir.transaksi.main',compact('title','link','page'));
    }

    public function delete($id) 
    {
        TransaksiKasir::where('id_transaksi',$id)->delete();
        return redirect('/kasir/data-penjualan')->with('message','Berhasil Hapus Data');
    }
    ...
    public function transaksiDetail($id) 
    {
        ...
        return view('Kasir.transaksi.detail',compact('id','title','link','page','nomor_transaksi'));
    }
    ...
    public function deleteTransaksiDetail($id,$id_detail) 
    {
        ...
        return redirect('/kasir/data-penjualan/detail/'.$id)->with('message','Berhasil Hapus Data');
    }
    ...
    public function cetakInvoice($id)
    {
        ...
        return view('Kasir.print-bayar',compact('transaksi','transaksi_detail','profile_instansi','sum_diskon','sum_sub_total_obat'));
    }
}
