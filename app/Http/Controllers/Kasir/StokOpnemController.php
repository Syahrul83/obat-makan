...
class StokOpnemController extends Controller
{
    ...
    {
        $title = 'Data Stok Opnem | Kasir';
        $page  = 'stok-opnem';
        return view('Kasir.stok-opnem.main',compact('title','page'));
    }

    public function tambah() 
    {
        $title       = 'Form Stok Opnem | Kasir';
        $page        = 'stok-opnem';
        $paging_obat = new Obat;
        // $uuid     = generateUuid();
        $count_obat  = Obat::where('status_delete',0)->count();
        return view('Kasir.stok-opnem.form-stok-opnem',compact('title','page','paging_obat','count_obat'));
    }
    ...
    public function lanjutInput($id)
    {
        ...
        return view('Kasir.stok-opnem.form-stok-opnem',compact('title','page','obat','tanggal_stok_opnem','keterangan','id'));
    }

    public function delete($id) 
    {
        StokOpnem::where('id_stok_opnem',$id)->delete();
        return redirect('/kasir/stok-opnem')->with('message','Berhasil Hapus Stok Opnem');
    }
    ...
    public function save(Request $request) 
    {
        ...
        //     return redirect('/kasir/stok-opnem/lanjut-input/'.$id)->with('message',$message);
        // }
        // else {
        //     $data_stok_opnem = [
        //         'tanggal_stok_opnem' => $tanggal_stok_opnem,
        ...
        //     return view('Kasir.stok-opnem.stok-opnem-print',compact('tanggal_stok_opnem','total_nilai','get_detail_stok'));
        // }
    ...
    {
        $title = 'Data Detail Stok Opnem | Kasir';
        $page  = 'stok-opnem';
        return view('Kasir.stok-opnem.main-detail',compact('title','page','id'));
    }
    ...
    public function cetak($id)
    {
        ...
        return view('Kasir.stok-opnem.stok-opnem-cetak',compact('tanggal_stok_opnem','total_nilai','get_detail_stok'));
    }
    ...
    //     return redirect('/kasir/stok-opnem')->with('message','Berhasil Ubah Status Input');
    // }
