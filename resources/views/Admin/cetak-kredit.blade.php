		...
		<div class="wrapper container-fluid print">
		  ...
		  <section class="invoice">
			 <div class="col-xs-12">
				...
				<p style="margin:0;font-size:18px;"><b>Nomor Faktur Kredit : {{ $nomor_faktur }}</b></p>
		      </div>
			<hr>
			<table border="1" width="100%">
				...
				<tbody>
					...
					<tr>
						...
						<td>{{format_rupiah(get_discount($value->hja_relasi * $value->banyak_obat, $value->diskon))}}</td>
						@else
						<td>{{format_rupiah($value->diskon)}}</td>
						@endif
