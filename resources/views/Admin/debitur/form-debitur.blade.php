                    ...
                    <form action="{{url('/admin/data-debitur/save')}}" method="POST">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" value="{{isset($row)?$row->name:''}}" placeholder="nama debitur" required="required">
                            </div>
                            <div class="form-group">
                                <label for="">margin</label>
                                <input type="number" name="margin" class="form-control" value="{{isset($row)?$row->margin:''}}" placeholder="margin" required="required">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="type" name="bilangan">
                                    ...
                                    @endphp
                                    @foreach($arr as $item)
                                    <option value="{{ $item }}" @if($row->bilangan === $item) selected='selected' @endif> {{ strtoupper($item) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
