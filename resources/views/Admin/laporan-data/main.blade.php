		...
		<div class="row">
			{{-- <div class="col-md-6">
				<div class="box box-default">
					...
					<div class="box-body">
						<form action="{{url('/admin/laporan-data/transaksi')}}">
							<div class="col-md-5">
			...
			<div class="col-md-6">
				<div class="box box-default">
					...
					<div class="box-body">
						<form action="{{url('/admin/laporan-data/transaksi-racik-obat')}}">
							<div class="col-md-5">
								<div class="form-group">
									<label for="">Dari</label>
									<input type="date" name="from" class="form-control" required="required" {!!isset($_GET['from'])?'value="'.$_GET['from'].'"':''!!}>
			...
			<div class="col-md-6">
				<div class="box box-default">
					...
					<div class="box-body">
						<form action="{{url('/admin/laporan-data/pemakaian-obat')}}">
							<div class="col-md-5">
								<div class="form-group">
									<label for="">Dari</label>
									<input type="date" name="from" class="form-control" required="required" {!!isset($_GET['from'])?'value="'.$_GET['from'].'"':''!!}>
			...
			<div class="col-md-6">
				<div class="box box-default">
					...
					<div class="box-body">
						<form action="{{url('/admin/laporan-data/pemakaian-per-dokter')}}">
							<div class="col-md-5">
								<div class="form-group">
									<label for="">Dari</label>
									<input type="date" name="from" class="form-control" required="required" {!!isset($_GET['from'])?'value="'.$_GET['from'].'"':''!!}>
			...
			<div class="col-md-6">
				<div class="box box-default">
					...
					<div class="box-body">
						<form action="{{url('/admin/laporan-data/pemakaian-per-supplier')}}">
							<div class="col-md-5">
								<div class="form-group">
									<label for="">Dari</label>
									<input type="date" name="from" class="form-control" required="required" {!!isset($_GET['from'])?'value="'.$_GET['from'].'"':''!!}>
			...
			<div class="col-md-6">
				<div class="box box-default">
					...
					<div class="box-body">
						<form action="{{url('/admin/laporan-data/pemakaian-per-pabrik')}}">
							<div class="col-md-5">
								<div class="form-group">
									<label for="">Dari</label>
									<input type="date" name="from" class="form-control" required="required" {!!isset($_GET['from'])?'value="'.$_GET['from'].'"':''!!}>
