			...
			<div class="col-md-12">
				<div class="box box-default">
					<div class="box-header">
						<a href="{{ url('/admin/data-kredit/detail/'.$id) }}">
						...
						<div class="row">
							<div class="col-md-12">
								<form action="{{ url('/admin/data-kredit/detail/'.$id.'/cetak-kredit-range',$id_faktur) }}" style="margin-top:1%;">
									@csrf
									<div class="col-md-3">
							...
							<div class="col-md-6">
								<a href="{{ url('/admin/data-kredit/detail/'.$id.'/lihat-hutang/'.$id_faktur.'/lunas-semua') }}">
