...
<body class="receipt">
    <p>
        <a href="{{ url('/admin/data-penjualan') }}" class="btn-hide">Kembali</a>
    </p>
        ...
        <table border="0" width="100%">
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ money_receipt(get_discount($value->hja_upds * $value->jumlah,$value->diskon)) }}</td>
                    <td></td>
                </tr>
                @endif
                ...
                <tr>
                    <td colspan="2" align="right">Diskon :</td>
                    <td>{{ money_receipt($value->diskon) }}</td>
                    <td></td>
                </tr>
                @endif --}}
            	@endforeach
