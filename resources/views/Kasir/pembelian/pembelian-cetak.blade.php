			...
			<table width="100%">
				...
				<tbody>
					...
					<tr>
						...
						<td class="border-table" width="10%">{{format_rupiah($value->harga_obat)}}</td>
					...
					<tr>
						...
						<td class="border-table">{{ format_rupiah($calc_dpp) }}</td>
					</tr>
					<tr>
						<td></td>
						<td></td>
						...
						<td align="center" class="border-table">:</td>
						<td class="border-table">{{ format_rupiah($pembelian->total_semua - $calc_dpp) }}</td>
					</tr>
					@else
					<tr>
						<td></td>
